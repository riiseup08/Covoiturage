    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Card>
          ...
          <DetailRow icon="calendar-outline" label="Départ" value={formatDate(trip.date_depart)} />
          <DetailRow icon="time-outline" label="Arrivée" value={formatDate(trip.date_arrivee)} />
          <DetailRow icon="people-outline" label="Places disponibles" value={`${trip.places_disponibles}`} />
          <DetailRow icon="pricetag-outline" label="Prix par place" value={`${trip.prix_par_place} ${trip.currency}`} />
          <DetailRow icon="briefcase-outline" label="Bagages" value={trip.type_bagage_accepte} />
          {trip.women_only && <DetailRow icon="female" label="Réservé aux femmes" value="Oui" color={Colors.female} />}
        </Card>
        ...
        {(trip.modele_voiture || trip.plaque_immatriculation) && (
          <Card>
            ...
            {trip.modele_voiture && <DetailRow icon="car-outline" label="Modèle" value={trip.modele_voiture} />}
            {trip.plaque_immatriculation && <DetailRow icon="document-text-outline" label="Plaque" value={trip.plaque_immatriculation} />}
          </Card>
        )}
        ...
        <Card>
          ...
          {trip.accept_mobile_money && <DetailRow icon="phone-portrait-outline" label="Mobile Money" value="Accepté" color={Colors.success} />}
          {trip.accept_cash && <DetailRow icon="cash-outline" label="Espèces" value="Accepté" color={Colors.success} />}
        </Card>
